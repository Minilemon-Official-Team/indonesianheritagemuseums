...
export default function AutoGuide() {
    ...
    const { currentLang, getDescription, getAudio, prefetchTranslation, isLoading } = useTranslationContext();
        ...
        <div className="bg-[#F4EFE6] min-h-screen">
            ...
            <div className="max-w-[1200px] mx-auto px-4 py-12">
                {museumData.map((zone, index) => {
                    ...
                    const audioUrl = getAudio(zone.name);
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6 p-6">
                                    ...
                                    <div className="flex flex-col justify-center">
                                        ...
                                        <audio key={`${zoneKey}-${currentLang}`} controls src={audioUrl}>
